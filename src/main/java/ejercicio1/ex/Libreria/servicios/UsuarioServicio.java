...
import ejercicio1.ex.Libreria.enums.Rol;
import ejercicio1.ex.Libreria.repositorios.UsuarioRepositorio;
...
public class UsuarioServicio implements UserDetailsService {
    ...
    public void deshabilitar(String id) throws ErrorServicio {
        ...
        if (respuesta.isPresent()) {
            ...
            throw new ErrorServicio("No se encontro el usuario indicado");
        }
    }
...
///////////////////////////////////////////////
    public void validar(String nombre, String apellido, String mail, String clave, String clave2) throws ErrorServicio {
        ...
        if (mail == null || mail.isEmpty()) {
            throw new ErrorServicio("El mail del usuario no puede ser null");
        }
        if (clave == null || clave.length() < 6) {
            throw new ErrorServicio("La clave del usuario no puede ser null o menor de 6 digitos");
        }
